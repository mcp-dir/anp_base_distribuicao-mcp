...
ANP: Base de Distribuição segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [anp_base_distribuicao@mcp.ai](mailto:anp_base_distribuicao@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
